---
slug: 'super-simple-start-to-es-modules-in-the-browser'
title: 'Super Simple Start to ESModules in the Browser'
date: '2020-01-22'
author: 'Kent C. Dodds'
description:
  "_All major browsers support ESModules now. Here's how to get started using
  them._"
categories:
  - 'javascript'
keywords:
...
bannerCredit:
  'Photo by [JOSE LARRAZOLO](https://unsplash.com/photos/S8bde3hkBR8)'
---

Current Available Translations:

- [Português (do Brasil)](https://medium.com/p/1399d9dd80b3)
